      ...
      >
        ...
        <DialogContent dividers sx={{ background: '#15171A' }}>
          <Accordion defaultExpanded sx={{ background: '#0f1113' }}>
            ...
            <AccordionDetails>
              ...
              <ul>
                ...
                <li>{t('itteachser8')}</li>
                <li>{t('itteachser9')}</li>
                <li>{t('itteachser10')}</li>
                <li>{t('itteachser11')}</li>
              </ul>
            </AccordionDetails>
          </Accordion>
          <Accordion defaultExpanded>
            ...
            <AccordionDetails>
              <ul>
                <li>{t('itteachser12')}</li>
                <li>{t('itteachser13')}</li>
                <li>{t('itteachser14')}</li>
                <li>{t('itteachser15')}</li>
                <li>{t('itteachser16')}</li>
              </ul>
            </AccordionDetails>
          </Accordion>
          <Accordion defaultExpanded>
